...
def get_args_parser():
    ...
    parser.add_argument(
        "--img_size", type=int, default=224, help="image size for mae vit"
    )
...
def main(args):
    ...
    img_list = sorted(Path(args.data_path).rglob("*_IM.tiff"))
    transform = Compose(
        [
            LoadTiff(),
    ...
    dataset_train = Dataset(img_list, transform=transform)
